  ...
  return (
    <section className="py-24 bg-slate-50 dark:bg-zinc-950">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <ScrollReveal delay={0.2}>
            <p className="mt-6 text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
              Minivel combines customer management, lead tracking, analytics,
              task organization, and secure collaboration into one modern CRM
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 mt-20">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="bg-white dark:bg-zinc-900 rounded-3xl border border-slate-200 dark:border-zinc-800 p-8 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl"
            >
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            {steps.map((step, index) => (
              <motion.div
                ...
                whileHover={{ y: -8 }}
                className="rounded-3xl bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 p-8 text-center shadow-sm transition-all duration-300 hover:shadow-xl"
              >
                <div className="text-5xl mb-5">{step.number}</div>
        ...
        {/* Bottom Summary */}
        <div className="mt-24 rounded-[36px] bg-gradient-to-r from-blue-700 via-indigo-700 to-purple-700 p-12 text-center text-white">
          <h2 className="text-4xl font-black">Built for Modern Businesses</h2>

          <p className="mt-6 text-lg leading-relaxed text-blue-100 max-w-3xl mx-auto">
            Minivel is designed to simplify customer relationships, streamline
            sales workflows, improve team collaboration, and provide
            actionable insights through one secure, fast, and intuitive CRM
            platform.
          </p>
        </div>
      </div>
